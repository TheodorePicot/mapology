    ...
    <section class="py-16">
        <div class="max-w-screen-2xl p-8 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <x-front.home.feature-card icon="heroicon-o-globe-europe-africa" title="Official Geography Content"
                                          text="Expert-curated lessons about countries, capitals, and landmarks"/>
                <x-front.home.feature-card icon="heroicon-o-flag" title="Official Flag Studies"
                                          text="Learn vexillology and master national flags through our official content"/>
                <x-front.home.feature-card icon="heroicon-o-book-open" title="Community Quizzes"
                                          text="Create, share, and take quizzes made by fellow geography enthusiasts"/>
                <x-front.home.feature-card icon="heroicon-o-user-group" title="Knowledge Wiki"
